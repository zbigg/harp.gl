...
describe("map-view#Utils", function() {
    ...
    describe("fitPointsToScreen", function() {
        const epsilon = 1e-10;
        it("works across antimeridian #1", function() {
            const fitted = MapViewUtils.fitPointsToScreen([
                new GeoCoordinates(10, -170),
                new GeoCoordinates(10, 170),
                new GeoCoordinates(-10, -170)
            ]);
            console.log("X", fitted);
        ...
        it("works across antimeridian #2", function() {
            const fitted = MapViewUtils.fitPointsToScreen([
                new GeoCoordinates(10, 170),
                new GeoCoordinates(10, -170),
                new GeoCoordinates(-10, 170)
        ...
        it("works across antimeridian #3", function() {
            const fitted = MapViewUtils.fitPointsToScreen([
                new GeoCoordinates(10, 170),
                new GeoCoordinates(10, -170),
                new GeoCoordinates(-10, 170),
