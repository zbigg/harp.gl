            ...
            for (const styleSetName in theme.styles) {
                ...
                styleSet.forEach(style => {
                    if (style.description === "urban area") {
                        ...
                        style.attr = {
                            color: "#ffffff",
                            map: "resources/wornpaintedcement-albedo.png",
                            mapProperties: {
                                repeatU: 2,
                                repeatV: 2,
                                wrapS: "repeat",
                            ...
                            normalMap: "resources/wornpaintedcement-norrmal.png",
                            normalMapProperties: {
                                repeatU: 2,
                                repeatV: 2,
                                wrapS: "repeat",
                            ...
                            roughnessMap: "resources/wornpaintedcement-roughness.png",
                        ...
                        style.attr = {
                            color: "#ffffff",
                            map: "resources/grass1-albedo3.png",
                            mapProperties: {
                                repeatU: 2,
                                repeatV: 2,
                                wrapS: "repeat",
                            ...
                            normalMap: "resources/grass1-normal1-dx.png",
                            normalMapProperties: {
                                repeatU: 2,
                                repeatV: 2,
                                wrapS: "repeat",
                            ...
                            roughnessMap: "resources/grass1-rough.png",
                            roughnessMapProperties: {
                                repeatU: 2,
                                repeatV: 2,
                                wrapS: "repeat",
                    ...
                    } else if (style.description === "water") {
                        style.technique = "standard-textured";
                        style.attr = {
                            color: "#ffffff",
                            map: "resources/Water_001_COLOR.jpg",
                            mapProperties: {
                                repeatU: 2,
                                repeatV: 2,
                                wrapS: "repeat",
                            ...
                            normalMap: "resources/Water_001_NORM.jpg",
                            normalMapProperties: {
                                repeatU: 2,
                                repeatV: 2,
                                wrapS: "repeat",
